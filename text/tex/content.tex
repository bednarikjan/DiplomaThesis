...
If the occlusion is spotted, the output confidence $conf$ of the tacker (see Section \ref{txt:measurement_confidence}) can be set $0$ in order to disregard this measurement completely:
\begin{align}
conf = 
	\begin{cases}
