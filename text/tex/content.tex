...
- pro trackovani byl pouzit TLD a BGFG tracker (zminit zkratku BGFG)
- zminit, ze nasledujici dve kapitoly shrnuji upravy pouze BGFG trackeru

%.........................................................................
%.........................................................................
\subsection{Measurement Belief}

As explained in Section \ref{txt:precision_of_the_localization} the system is subject to multiple different sources of error which influence the precision of localization. As far as the visual tracking subsystem is concerned, the random error caused mostly by the common difficulties, such as the background clutter, varying illumination, target appearance change etc. (see Section \ref{txt:object_model}) is of the most significance. Furthermore, in the worst case scenario the tracker might fail completely and never recover unless the human operator interferes.

Nevertheless, since the OLS is designed as multi-camera system, the random error or failure of a single tracker might be compensated by the rest of the units, thus alleviating the total impact on the localization precision. In order to denote the certainty of the measurements coming from individual trackers, the notion of \textit{belief} is introduced for the BGFG tracker which the OLS is based on (the operation of BGFG tracker is described in Section \ref{txt:bgfg_tracker}).
...
%.........................................................................
%.........................................................................
\subsection{Adjusting Prediction Step Using Frame Differencing}
...
%.........................................................................
%.........................................................................
\subsection{2D Motion Prediction and Regulation}
...
Given the time stamped ($t$) states of the manipulator $\vec{m} = (\phi, \psi)$ where $\phi$ and $\psi$ are the angular positions (given in $radians$) and tracker measurements $\vec{p} = (x, y)$, where $x$ and $y$ are the positions of the target (given in $pixels$), the 2D angular speed of the taregt $\vec{\omega_{t}}$ can estimated as the moving average over $N$ last measurements $i$ as well as the angular difference $\vec{d}$ between the current and future 2D position in $T$ seconds:
...
Then it is necessary to regulate the motion of the manipulator which is forced to the given future position. Smooth motion is absolutely necessary...
...
\begin{align}
	...
	\end{cases},\\	
\end{align}
where $f_{reg}$ is either linear ($f_{lin} = ax+b$) or power ($f_{pow} = ax^{k}+b$) function.
...
\todo{promitani do stejne roviny podle belief, triangulace}
...
\todo{algoritmus z excel}

%.........................................................................
%.........................................................................
\subsection{3D Motion Prediction}
